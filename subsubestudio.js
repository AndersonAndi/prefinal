...
(function(){
  ...
  async function cargarCSV() {
    ...
    const resp = await fetch(ruta2); // ✅ agregar esta ruta en tu datosMedios
...
const ruta1 = `${medio}/${mes}/${dia}/comentarios_evaluados.csv`;
const ruta2 = `${medio}/${mes}/${dia}/ordParInd.csv`;
const ruta3 = `${medio}/${mes}/${dia}/palabras_por_fila.csv`;
const ruta4 = `${medio}/${mes}/${dia}/totales.csv`;
...
window.addEventListener("DOMContentLoaded", async () => {
  ...
  datosOriginal = await cargarCSV(ruta1);
  ordenParamMap = await cargarOrdenParamMap(ruta2);
